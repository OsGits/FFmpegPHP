...
if ($is_batch_transcode) {
    ...
    foreach ($selected_files as $file) {
        ...
        // 处理单个文件
        process_single_file($file, $output_dir, $base_url, $segment_duration, $screenshot_time, $quality, $use_gpu);
        
        // 每转码完成一个文件，等待1秒再处理下一个
        sleep(1);
    }
...
// 单个文件转码处理
process_single_file($input_file, $output_dir, $base_url, $segment_duration, $screenshot_time, $quality, $use_gpu);
